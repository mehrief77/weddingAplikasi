    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="nama" name="nama" value="<?= $tb_customer['nama']; ?>">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="no_telp" name="no_telp" value="<?= $tb_customer['no_telp']; ?>">
                    <?= form_error('name', '<small class="text-danger pl-3">', '</small>'); ?>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="email" name="email" value="<?= $tb_customer['email']; ?>" readonly>
                </div>
            </div>

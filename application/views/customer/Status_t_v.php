			...
			?>
					...
					<tr align="center">
						...
						<td data-header="STATUS PEMBAYARAN">
							<div class="main"><?php echo $inv->status_pembayaran ?></div>
						</td>
						<td data-header="Aksi">
							<div class="main"><?php echo anchor('Customer/detail_status/' . $inv->id_invoice, '<div class="btn btn-primary btn-sm">Status</div>') ?></div>
						</td>
					</tr>

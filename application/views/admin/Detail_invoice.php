<div class="container-fluid">
	...
	<a href="<?php echo base_url('admin/Invoice/cek_bukti/' . $psn->id_invoice) ?>">
		<div class="btn btn-primary btn-sm"> Cek Bukti </div>
	</a>

	<a href="<?php echo base_url('admin/Invoice/status_dr_c/' . $psn->id_invoice)  ?>">
		<div class="btn btn-success btn-sm"> <img src="<?= base_url('assets/img/status.png'); ?> " width="20px"> Status Customer </div>
	</a>

	<!-- <a href="<?php echo base_url('admin/Invoice/status_c/' . $psn->id_invoice)  ?>">
		<div class="btn btn-success btn-sm"> <img src="<?= base_url('assets/img/status.png'); ?> " width="20px"> Status Customer </div>
	</a> -->
	<!-- <td><?php echo anchor('admin/Invoice/status_c/' . $psn->id_invoice, '<div class="btn btn-success btn-sm">Status Customer</div>') ?></td> -->

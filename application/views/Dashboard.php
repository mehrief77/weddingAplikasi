		...
		<div class="row text-center mt-4">
			<?php foreach ($wedding as $wd) : ?>
				...
				<div class="card ml-3 mb-3" style="width: 16rem;">
					<img src="<?php echo base_url() . 'uploads/' . $wd->gambar ?>" class="img-thumbnail width=240px" alt="...">
					<div class="card-body">
						...
						<!-- <div class="row">
							<div class="col-md-12">
								<?php echo anchor('Dashboard/detailnya/' . $wd->id, '<div class="btn btn-info btn-sm"> Selengkapnya </div>')  ?>
							</div>
						</div> -->
						...
						<!-- <div class="row">
							<div class="col-md-12"><a href="<?= base_url(); ?>/Dashboard/tambah_ke_pesan/<?= $wd->id ?>">
